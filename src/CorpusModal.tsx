...
export class CorpusModal extends React.Component<
  CorpusModalProps,
  CorpusModalState
> {
  ...
  componentDidMount() {
    ...
    corpusModalDiv.addEventListener(
      'show.bs.modal',
      () => {
        fetch('/topic/list')
  ...
  render() {
    let content: JSX.Element[] = [
      <li className="list-group-item list-group-item-light">Chargement...</li>,
    ];
    let count: number = 0;
          ...
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">
                Corpus de données · {count} topics
              </h5>
              <button
                type="button"
                className="btn-close"
